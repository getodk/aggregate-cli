...
1. [Set up your development environment](https://github.com/getodk/aggregate-cli#setting-up-your-development-environment). 
...
1. When your changes are ready to be added to the core ODK Aggregate CLI project, [open a pull request](https://help.github.com/articles/creating-a-pull-request/). Make sure to set the base fork to `getodk/aggregate-cli`. Describe your changes in the comment, refer to any relevant issues using [keywords for closing issues](https://help.github.com/articles/closing-issues-via-commit-messages/) and tag any person you think might need to know about the changes.

1. Pull requests will be reviewed when committers have time. If you haven't received a review in 10 days, you may notify committers by putting `@getodk/aggregate-cli` in a comment.
